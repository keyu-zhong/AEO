...
C_pool=[Ceq1; Ceq2; Ceq3; Ceq4; Ceq_ave];                     % Equilibrium pool
 ...
 t=(1-Iter/Max_iter)^(a2*Iter/Max_iter);                      % Eq (9)
    ...
    for i=1:size(C,1)  
       ...
       Iter=Iter+1;  
       disp(['AEO Iteration ' num2str(Iter) ': Best Cost = ' num2str(Ceq1_fit)]);
...
display(['The best Cost_per found by AEO is : ', num2str(Best_F1,10)]);
display(['The best Farmpower found by AEO is : ', num2str(Best_F2,10)]);
display(['The best Efficiency found by AEO is : ', num2str(Ceq1_fit,10)]);
fprintf('--------------------------------------\n');
end
